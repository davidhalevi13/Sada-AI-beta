...
import type { ChatSuggestionIcon } from '@/chat/types';
...
const iconMap: Record<ChatSuggestionIcon, () => React.JSX.Element> = {
  slack: SlackIcon,
  jira: JiraIcon,
  notion: NotionIcon,
  ...
  return (
    <Button
      ...
      style={{
        ...
        borderRadius: '999px',
        background: 'linear-gradient(135deg, rgba(139, 92, 246, 0.16), rgba(37, 99, 235, 0.1))',
