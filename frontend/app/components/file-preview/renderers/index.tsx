  ...
  return (
    ...
    >
      ...
      <Text size="2" color="gray" style={{ textAlign: 'center', maxWidth: '400px' }}>
        {isLegacyDoc
          ? 'This file is in legacy Word (.doc) format. In-browser preview is not supported here; download it to open in Word, or save a copy as .docx to preview in Sada AI.'
